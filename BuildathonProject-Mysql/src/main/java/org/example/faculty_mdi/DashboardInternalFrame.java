...
public class DashboardInternalFrame extends JInternalFrame {
    ...
    public DashboardInternalFrame() {
        ...
        totalOrderValue = createValueLabel("2018");
        totalOrderValue.setBounds(20, 20, 150, 30);

        totalOrderText = createTextLabel("Faculty Since");
        ...
        revenueValue = createValueLabel("Computer Science");
        revenueValue.setBounds(20, 20, 250, 30);

        revenueText = createTextLabel("Head Of Department");
        revenueText.setBounds(20, 60, 150, 20);
        ...
        activeUserValue = createValueLabel("50");
        activeUserValue.setBounds(20, 20, 150, 30);

        activeUserText = createTextLabel("Assignment Given");
        ...
        pendingTaskValue = createValueLabel("200");
        pendingTaskValue.setBounds(20, 20, 150, 30);

        pendingTaskText = createTextLabel("Students Under");
        pendingTaskText.setBounds(20, 60, 150, 20);
