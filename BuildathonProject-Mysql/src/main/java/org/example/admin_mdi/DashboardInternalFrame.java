...
public class DashboardInternalFrame extends JInternalFrame {
    ...
    public DashboardInternalFrame() {
        ...
        totalOrderValue = createValueLabel("7");
        totalOrderValue.setBounds(20, 20, 150, 30);

        totalOrderText = createTextLabel("Branches Available");
        ...
        revenueValue = createValueLabel("50");
        revenueValue.setBounds(20, 20, 180, 30);

        revenueText = createTextLabel("Total Faculties");
        ...
        activeUserValue = createValueLabel("500");
        activeUserValue.setBounds(20, 20, 150, 30);

        activeUserText = createTextLabel("Total Students");
        ...
        pendingTaskValue = createValueLabel("95%");
        pendingTaskValue.setBounds(20, 20, 150, 30);

        pendingTaskText = createTextLabel("Placement");
